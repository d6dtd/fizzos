...
#define PG_RW_FLAG 0b10    /* 1表示可读写执行，0表示只读执行 */
#define PG_RWE 0b10
#define PG_RE 0

#define PG_US_FLAG 0b100    /* 1表示用户级，0表示管理员级 */
#define PG_USER 0b100    
#define PG_SUPERVISOR 0

#define PG_ACCESSED_FLAG 0b100000
#define PG_DIRTY_FLAG  0b1000000 
/* ------------------------------------------------------- */
#define UNUSED __attribute__ ((unused))

#define OFFSET(type, attr) ((uint32_t)(&((type*)0)->attr))
#define elem2entry(type, attr, elem) ((type*)((uint32_t)elem - OFFSET(type, attr)))

#define __user // 标记一下用户态的东西
